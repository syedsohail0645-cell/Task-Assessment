...
#Creating Subnet's public Subnet
...
#Creating-IGW-for-new-vpcheck "name" 
...
resource "aws_nat_gateway" "private_nat_gateway" {
  ...
  tags = {
    Name = "Terraform-Private-NatGateway"
  }
}
...
resource "aws_route_table" "public_route_table" {
  ...
  depends_on = [aws_subnet.public_subnet, aws_internet_gateway.Public-igw]
